...
class Solver(object):
    ...
    def __init__(self, f, n, n_trials=10):
        ...
        '''
        TOKEN_API = "e20def9bd4d3625bcf0992006637b1683897a6b48b9564d3df2890bddf2bace7bcb001d226205eca96b3eb570660e90f23bb356f2236dc2a11c7fc775aa9ec70"
        IBMQ.save_account(TOKEN_API)
    ...
    def solve(self):
        ...
        self.__mapped_circuit = transpile(self.__circuit, self.backend)
        qobj = assemble(self.__mapped_circuit, self.backend, shots=1000)
